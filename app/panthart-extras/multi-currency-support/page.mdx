...
- **One-time integration fee:** **$1,000 worth of DCNT** (Panthart’s native token) — payable **after DCNT launch**.
...
- Team wallet able to pay **$1,000 worth of DCNT** (one-time) **after DCNT launch**.
...
After DCNT is live, settle **$1,000 worth of DCNT** to the integration address shown in the UI.
...
Panthart admin after reach out will use prevailing market value of the DCNT amount equivalent to **$1,000** at the time of payment and provide the settlement address.
...
- **Today:** ETN only.  
- **Post-launch:** ERC-20 integrations via one-time **$1,000 DCNT** fee.  
